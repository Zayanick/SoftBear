			...
			<article id="tab4">
				<form action="/crearCliente" method="post">
					<section class="registro"> 
                        ...
                        <input class="controls" type="text" name="nit" id="nit" placeholder="Ingrese su NIT" value="${clientes.cedula}">
                        <input class="controls" type="text" name="proveedor" id="proveedor" placeholder="Nombre Proveedor" value="${clientes.direccion}">
                        <input class="controls" type="text" name="direccion" id="direccion" placeholder="Ingrese su Direccion" value="${clientes.email}">
                        <input class="controls" type="text" name="telefono" id="telefono" placeholder="Ingrese su Telefono" value="${clientes.telefono}">
                        <input class="controls" type="text" name="ciudad" id="ciudad" placeholder="Indique su Ciudad" value="${clientes.telefono}">
                        <br>
