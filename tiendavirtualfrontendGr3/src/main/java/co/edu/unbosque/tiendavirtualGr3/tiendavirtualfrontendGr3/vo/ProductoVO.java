...
//Atributos de la tabla de productos
public class ProductoVO {
	...
	public ProductoVO(Integer codigo, Long nitProveedor, Float ivaCompra, String nombre, Float precioCompra,
			Float precioVenta) {
		super();
		this.codigo = codigo;
	...
	public String toString() {
		return "ProductoVO [codigo=" + codigo + ", nitProveedor=" + nitProveedor + ", ivaCompra=" + ivaCompra
